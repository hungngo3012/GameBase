...
namespace NinthArt
{
    internal class SceneManager : Singleton<SceneManager>
    {
        ...
        public static void OpenSceneShield()
        {
            Instance.popupShield.Show();
        }
        public static SceneID SceneId(string id)
        {
            SceneID result;
            ...
            {
                throw new ArgumentException($"Không thể chuyển đổi {id} thành SceneId.");
            }
        }
    }
}